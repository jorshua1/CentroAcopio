...
namespace CentroAcopio.Views.Client
{
    public partial class UpdateClient : Window
    {
        ...
        public UpdateClient(object cedula)
        {
            InitializeComponent();
            ObtenerCiudades();
        ...
        private void GetInfoFromCedula(object cedula)
        {
            ...
            cmd.CommandText =
                "SELECT NOM_NOMBRE, NOM_APELLIDO, DIRECCION, TELEFONO, NOMBRECOMERCIAL, COD_CIUDAD FROM CLIENTE WHERE CEDULA = :cedula";
            ...
            while (reader.Read())
            {
                ...
                var nombreComercial = reader["NOMBRECOMERCIAL"].ToString();
        ...
        private void Enviar_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                using (var conexion = CrearConexion.ConexionDB_Oracle())
                {
                    ...
                    cmd.CommandText =
                        "UPDATE CLIENTE " +
                        "SET NOM_NOMBRE = :nombre, NOM_APELLIDO = :apellido, DIRECCION = :direccion, TELEFONO = :telefono, NOMBRECOMERCIAL = :nombreComercial, COD_CIUDAD = :codigoSeleccionado " +
                        "WHERE CEDULA = :cedula";
